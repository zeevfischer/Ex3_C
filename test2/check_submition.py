...
def main():
    ...
    test_output_vs_expected("stringProg" , "../inputs/input.txt" , "../outputs/output.txt")
    test_output_vs_expected("stringProg" , "../inputs/input1.txt" , "../outputs/output1.txt")
    test_output_vs_expected("stringProg" , "../inputs/input2.txt" , "../outputs/output2.txt")
    test_output_vs_expected("stringProg" , "../inputs/input3.txt" , "../outputs/output3.txt")
    test_output_vs_expected("stringProg" , "../inputs/input4.txt" , "../outputs/output4.txt")
